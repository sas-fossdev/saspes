<template>
    <div>
        ...
        <footer>
            ...
            <br>
            If you believe you have encountered a bug in the extension, or have any other inquiries, please create an issue on <a href="https://github.com/sas-fossdev/saspes/issues"> the repository</a> or email <a href="mailto:contact@suhas.net">contact@suhas.net</a><br>
            <br>
            Credits: <br>
